...
const ServicesIcon = ({ className }) => (
  <svg viewBox="0 0 24 24" className={className} fill="none" aria-hidden="true">
    <path d="M3 10V19C3 20.1046 3.89543 21 5 21H19C20.1046 21 21 20.1046 21 19V10" stroke="currentColor" strokeWidth="1.5" />
    <path d="M14.834 21V15C14.834 13.8954 13.9386 13 12.834 13H10.834C9.72941 13 8.83398 13.8954 8.83398 15V21" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="16" />
    ...
    <path d="M14 10C14.5675 9.82538 15.2879 9.42589 15.6909 9.18807C15.8828 9.07486 15.9884 8.86103 15.9699 8.63904L15.5 3H8.5L8.03008 8.63904C8.01158 8.86103 8.11723 9.07486 8.30906 9.18807C8.71207 9.42589 9.4325 9.82538 10 10C11.493 10.4594 12.507 10.4594 14 10Z" stroke="currentColor" strokeWidth="1.5" />
...
const ChatsIcon = ({ className }) => (
  <svg viewBox="0 0 26 27" className={className} fill="none" aria-hidden="true">
    <path d="M8 13L12 13L16 13" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M8 17L10 17L12 17" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M12 25C17.5228 25 22 20.5228 22 15C22 9.47715 17.5228 5 12 5C6.47715 5 2 9.47715 2 15C2 16.8214 2.48697 18.5291 3.33782 20L2.5 24.5L7 23.6622C8.47087 24.513 10.1786 25 12 25Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    <circle cx="20" cy="6" r="6" fill="#FFCF70" />
    <path d="M18.467 8.163H21.815V9H17.387L17.414 8.595C17.438 8.157 17.537 7.737 17.711 7.335C17.909 6.873 18.317 6.483 18.935 6.165L19.664 5.76C20.048 5.556 20.324 5.349 20.492 5.139C20.66 4.923 20.744 4.662 20.744 4.356C20.744 4.026 20.639 3.765 20.429 3.573C20.225 3.381 19.94 3.285 19.574 3.285C18.752 3.285 18.341 3.714 18.341 4.572H17.396C17.39 3.9 17.579 3.378 17.963 3.006C18.347 2.634 18.893 2.448 19.601 2.448C20.249 2.448 20.765 2.622 21.149 2.97C21.539 3.324 21.734 3.774 21.734 4.32C21.734 4.77 21.608 5.166 21.356 5.508C21.104 5.85 20.708 6.165 20.168 6.453L19.529 6.813C19.163 7.017 18.899 7.218 18.737 7.416C18.581 7.614 18.491 7.863 18.467 8.163Z" fill="black" />
  </svg>
);

const UserIcon = ({ className }) => (
  <svg viewBox="0 0 24 24" className={className} fill="none" aria-hidden="true">
    <path d="M7 18V17C7 14.2386 9.23858 12 12 12C14.7614 12 17 14.2386 17 17V18" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
  ...
  return (
    <NavLink to={to} end className="flex items-center justify-center">
      {({ isActive }) => (
        <div
          className={[
            "w-20 aspect-square rounded-full grid place-items-center mx-auto",
            isActive
        ...
        >
          <div className="flex flex-col items-center justify-center gap-xxs">
            ...
            <p className="text-m text-center leading-tight truncate max-w-[4.5rem]" style={{ color: "inherit" }}>
              {label}
            </p>
          </div>
        </div>
...
export default function NavBar() {
  ...
  const profilePath = session?.user?.id ? `/profile/${session.user.id}` : "/signin";
  return (
    <nav className="fixed bottom-0 left-0 right-0 px-s pb-[env(safe-area-inset-bottom)]">
     <div className="mx-auto w-full rounded-full bg-[rgba(0,0,0,0.90)] px-s py-xs">
